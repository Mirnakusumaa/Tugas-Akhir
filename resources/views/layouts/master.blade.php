                        ...
                        <div class="col-md-12">
                            ...
                            <div class="main_portfolio_content">
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    <img src="{{ asset('assets/images/n1.png') }}" alt="" />
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    <img src="{{ asset('assets/images/n2.png') }}" alt="" />
                                    <div class="portfolio_images_overlay text-center">
                                        <h6>DEEP CLEANING</h6>
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    <img src="{{ asset('assets/images/n3.png') }}" alt="" />
                                    <div class="portfolio_images_overlay text-center">
                                        <h6>LEATHER CARE</h6>
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    <img src="{{ asset('assets/images/n4.png') }}" alt="" />
                                    <div class="portfolio_images_overlay text-center">
                                        <h6>REPAIR</h6>
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    <img src="{{ asset('assets/images/n5.png') }}" alt="" />
                                    <div class="portfolio_images_overlay text-center">
                                        <h6>REPAINT</h6>
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    <img src="{{ asset('assets/images/n6.png') }}" alt="" />
                                    <div class="portfolio_images_overlay text-center">
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    <img src="{{ asset('assets/images/n7.png') }}" alt="" />
                                    <div class="portfolio_images_overlay text-center">
                                        <h6>JUST FOR HER</h6>
                                        <p class="product_price">Rp. 30.000</p>
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    <img src="{{ asset('assets/images/n8.png') }}" alt="" />
                                    <div class="portfolio_images_overlay text-center">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6 product_img">
                        <img src="{{ asset('assets/images/hh.jpg') }}" class="img-responsive">
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6 product_img">
                        <img src="{{ asset('assets/images/yt.jpg') }}" class="img-responsive">
                    </div>
                    <div class="col-md-6 product_content">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6 product_img">
                        <img src="assets/images/t.jpg" class="img-responsive">
                    </div>
                    <div class="col-md-6 product_content">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6 product_img">
                        <img src="assets/images/te.jpg" class="img-responsive">
                    </div>
                    <div class="col-md-6 product_content">
                        <h4>Repair</h4><br>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6 product_img">
                        <img src="assets/images/tr.jpg" class="img-responsive">
                    </div>
                    <div class="col-md-6 product_content">
                        <h4>Repaint</h4><br>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6 product_img">
                        <img src="assets/images/x.jpg" class="img-responsive">
                    </div>
                    <div class="col-md-6 product_content">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6 product_img">
                        <img src="assets/images/ee.jpg" class="img-responsive">
                    </div>
                    <div class="col-md-6 product_content">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6 product_img">
                        <img src="assets/images/u.jpg" class="img-responsive">
                    </div>
                    <div class="col-md-6 product_content">
